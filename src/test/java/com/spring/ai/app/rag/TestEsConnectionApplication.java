...
public class TestEsConnectionApplication {

    public static void main(String[] args) {
        SpringApplication app = new SpringApplication(TestEsConnectionApplication.class);
    ...
    public CommandLineRunner commandLineRunner(ApplicationContext ctx) {
        return args -> {
            ...
            try {
                ElasticsearchClient elasticsearchClient = ctx.getBean(ElasticsearchClient.class);
